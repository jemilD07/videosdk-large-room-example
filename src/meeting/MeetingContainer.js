...
import LargeRoomView from "../largeRoom/LargeRoomView";
...
import { teardownRelay } from "../utils/audioOutputRelay";
    ...
    <>
      <div className={` flex flex-1 flex-row bg-gray-800 `}>
        <div className={`flex flex-1 `}>
          ...
          {/*
            Large room handling lives here: it pages through participants,
            pauses the streams it is not showing and keeps every participant
            audible. On mobile a screen share takes the whole viewport, so the
            view runs in audio-only mode.
          */}
          <LargeRoomView
            isPresenting={isPresenting}
            audioOnly={isPresenting && isMobile}
          />
        </div>
