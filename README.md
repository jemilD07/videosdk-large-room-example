# 🚀 Video SDK for React JS - Large Room Demo

> This is the official VideoSDK React example extended with a **large room**
> implementation: pagination, active-speaker priority, per-tile quality tiers and
> stream pause/resume for off-screen participants.
> **See [LARGE_ROOM.md](LARGE_ROOM.md) for what was added and where.**
> The README below is the original example's documentation.
